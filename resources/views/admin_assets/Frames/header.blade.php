...
<link rel="stylesheet" href="{{asset('back/plugins/css/idex.css')}}">
</head>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <nav class="mt-2">
        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <li class="nav-item">
                <a href="{{route('team.data')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Team Data</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('plan.form')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Plans</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('plan.data')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Plan Data</p>
                </a>
            </li>
