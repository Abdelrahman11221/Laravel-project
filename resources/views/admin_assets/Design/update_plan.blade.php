...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-6">
            ...
            <li class="breadcrumb-item active">Plan Update Page</li>
            </ol>
        </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="card-tools">
                ...
                <div class="card-body">
                    <div class="card card-info">
                        <div class="card-header">
                        <h3 class="card-title">Plan Update Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                    <form action="{{route('plan.edit')}}" method="POST">
                        @csrf
                        @method("PUT")
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="designs" value="{{$data->designs}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="dashbords" value="{{$data->dashbords}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="storage" value="{{$data->storage}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Bandwidth</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="bandwidth" value="{{$data->bandwidth}}">
                                </div>
                            </div>
                            <div class="form-group row">
